// Demo_02.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
static bool InitBehavic(behaviac::Workspace::EFileFormat ff)
{
	const char* szFilePath = "../../../../../../../Demos/Demo_02/behaviac/exported";
