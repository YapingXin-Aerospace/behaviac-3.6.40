...
namespace behaviac
{
	...
	inline void Set_FirstAgent_p2(Agent* self, int value) { ((FirstAgent*)self)->_Get_Property_<PROPERTY_TYPE_FirstAgent_p2, int >() = value; };
	inline const void* Get_FirstAgent_p2(Agent* self) { return &((FirstAgent*)self)->_Get_Property_<PROPERTY_TYPE_FirstAgent_p2, int >(); };
