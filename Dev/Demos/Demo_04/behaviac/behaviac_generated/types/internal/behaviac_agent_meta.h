...
namespace behaviac
{
	...
	inline void FunctionPointer_FirstAgent_Say(Agent* self, behaviac::string message) { ((FirstAgent*)self)->_Execute_Method_<METHOD_TYPE_FirstAgent_Say, void, behaviac::string >(message); }
}
